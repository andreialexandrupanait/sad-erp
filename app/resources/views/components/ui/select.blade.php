...
@php
    ...
    $baseClasses = 'appearance-none flex h-10 w-full items-center justify-between rounded-md border bg-white pl-3 pr-10 py-2 text-sm ring-offset-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-slate-50 transition-colors';
