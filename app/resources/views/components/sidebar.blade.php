    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3">
        ...
        <div class="mb-4">
            ...
            <div class="space-y-0.5">
                ...
                <a href="{{ route('financial.yearly-report', ['year' => now()->year]) }}" class="flex items-center px-3 py-1.5 text-sm rounded-md transition-colors {{ request()->routeIs('financial.yearly-report') ? 'bg-slate-100 text-slate-900' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
