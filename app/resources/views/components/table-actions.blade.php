@props(['viewUrl' => null, 'editUrl' => null, 'deleteAction' => null, 'deleteConfirm' => null])
...
<div class="flex items-center justify-end gap-3">
    ...
    @if($deleteAction)
        <form method="POST" action="{{ $deleteAction }}" class="inline-flex"
              onsubmit="return confirm('{{ $deleteConfirm ?? __('Are you sure you want to delete this item?') }}')">
            @csrf
            @method('DELETE')
            <button type="submit"
