    ...
    <div class="space-y-4">
        @foreach($credentialsBySite as $siteName => $siteCredentials)
            ...
            <div class="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden border-l-4"
                ...
                {{-- Site Group Header --}}
                <div class="bg-slate-100 flex items-center py-3 px-3">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button type="button"
                                @click="$dispatch('open-email-modal', {
                                    ...
                                    clientEmail: @js($firstCredential->client?->email ?? ''),
                                    clientName: @js($firstCredential->client?->name ?? '')
                                })"
                ...
                <div class="divide-y divide-slate-100">
                    @foreach($siteCredentials as $credential)
                        <div class="flex items-center py-3 px-3 hover:bg-blue-50/40 transition-colors text-sm"
                            ...
                            {{-- Checkbox + Platform --}}
                            <div class="flex items-center gap-3 shrink-0" style="width: 140px;">
                                <input type="checkbox"
                            ...
                            {{-- Username --}}
                            <div class="pl-6 shrink-0" style="width: 280px;">
