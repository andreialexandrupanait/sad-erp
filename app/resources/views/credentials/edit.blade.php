                    ...
                    <form method="POST" action="{{ route('credentials.update', $credential) }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input id="url" type="url" name="url" value="{{ old('url', $credential->url) }}"
                            ...
                            <div>
                                ...
                                <input id="username" type="text" name="username" value="{{ old('username', $credential->username) }}"
                            ...
                            <div>
                                ...
                                <textarea id="notes" name="notes" rows="3"
                                    ...
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">{{ old('notes', $credential->notes) }}</textarea>
                                @error('notes')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex items-center justify-end mt-6 gap-4">
                            <a href="{{ route('credentials.show', $credential) }}" class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100">
                                Cancel
                            </a>
