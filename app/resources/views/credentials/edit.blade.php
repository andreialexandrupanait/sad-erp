    ...
    <x-slot name="header">
        <div class="flex justify-between items-center px-6 lg:px-8 py-8">
            <div>
                ...
                <p class="mt-2 text-sm text-slate-600">Update credential information</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('credentials.update', $credential) }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-sm text-slate-500">Leave blank to keep the current password</p>
                                @error('password')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <x-ui.textarea
                                    ...
                                    class="mt-1.5"
                                >{{ old('notes', $credential->notes) }}</x-ui.textarea>
                                @error('notes')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
