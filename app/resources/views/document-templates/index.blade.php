                    ...
                    @foreach($initialTemplates as $template)
                        ...
                        <div class="p-4 space-y-3">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div class="flex flex-wrap items-center gap-1.5 mt-2">
                                        ...
                                        @if($template->is_default ?? false)
                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-amber-100 text-amber-700 rounded-full">
                                ...
                                <a href="{{ $isContract ? route('settings.contract-templates.edit', $template->id) : route('settings.document-templates.builder', $template->id) }}"
                                   class="text-blue-600 hover:text-blue-900 flex-shrink-0">
                            ...
                            <div class="text-xs text-slate-500">
                                {{ __('Updated') }}: {{ $template->updated_at ? \Carbon\Carbon::parse($template->updated_at)->format('d.m.Y') : '-' }}
                            </div>
                        </div>
                    @endforeach
                </div>
