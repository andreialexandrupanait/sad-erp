                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('internal-accounts.update', $internalAccount) }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <x-ui.input
                                    ...
                                    value="{{ old('nume_cont_aplicatie', $internalAccount->nume_cont_aplicatie) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <x-ui.input
                                    ...
                                    type="url"
                                    name="url"
                                    value="{{ old('url', $internalAccount->url) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <x-ui.input
                                    ...
                                    type="text"
                                    name="username"
                                    value="{{ old('username', $internalAccount->username) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-sm text-slate-500">Leave blank to keep the current password</p>
                                @error('password')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                >{{ old('notes', $internalAccount->notes) }}</x-ui.textarea>
                                @error('notes')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-slate-200">
                            <x-ui.button type="button" variant="outline" onclick="window.location.href='{{ route('internal-accounts.show', $internalAccount) }}'">
                                Cancel
                            </x-ui.button>
