                    ...
                    <form method="POST" action="{{ route('internal-accounts.store') }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input id="nume_cont_aplicatie" type="text" name="nume_cont_aplicatie" value="{{ old('nume_cont_aplicatie') }}" required
                        ...
                        <div class="flex items-center justify-end mt-6 gap-4">
                            <a href="{{ route('internal-accounts.index') }}" class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100">
                                Cancel
                            </a>
