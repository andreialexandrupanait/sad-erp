<x-app-layout>
    ...
    <div class="flex flex-col lg:flex-row min-h-screen bg-slate-50" x-data="{
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="lg:hidden p-4 border-b border-slate-200 bg-white">
                <label class="block text-sm font-medium text-slate-700 mb-2">{{ __('Section') }}</label>
                <select x-model="activeSection" @change="window.location.href = '?section=' + activeSection" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent">
                    <option value="application">Application Settings</option>
                    <option value="client_statuses">Status clienti</option>
                    <option value="domain_statuses">Status domenii</option>
                    <option value="subscription_statuses">Status abonamente</option>
                    <option value="access_platforms">Categorii platforme</option>
                    <option value="expense_categories">Categorii cheltuieli</option>
                    <option value="payment_methods">Metode de plata</option>
                    <option value="billing_cycles">Cicluri de facturare</option>
                    <option value="domain_registrars">Registratori de domenii</option>
                </select>
            </div>
