<x-app-layout>
    ...
    <div class="p-6 space-y-6"
         x-data="clientsPage({
             ...
             initialClients: @js($initialClients),
             initialPagination: @js($initialPagination),
             initialStatusCounts: @js($initialStatusCounts)
         })"
         x-init="init()">
                                ...
                                <template x-for="client in getClientsForStatus(status.id)" :key="client.id">
                                    <div class="p-3 bg-slate-50 hover:bg-slate-100 rounded-lg transition border border-transparent hover:border-slate-300">
                                        ...
                                        <div class="text-sm font-semibold text-slate-900 pt-2 border-t border-slate-200"
                                             x-text="formatCurrency(client.total_incomes, client.currency)">
                                        </div>
                                    </div>
                                </template>
        ...
        <template x-if="ui.viewMode === 'grid'">
            <div>
                <div x-show="clients.length === 0" class="text-center py-12">
                    <svg class="mx-auto h-12 w-12 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    <h3 class="mt-2 text-sm font-medium text-slate-900">{{ __('No clients found') }}</h3>
                        ...
                        <x-ui.card class="hover:shadow-lg transition-shadow">
                            <x-ui.card-content>
                                ...
                                <div class="mt-3 pt-3 border-t border-slate-200">
                                    ...
                                    <div class="text-lg font-semibold text-slate-900" x-text="formatCurrency(client.total_incomes, client.currency)"></div>
                                </div>
