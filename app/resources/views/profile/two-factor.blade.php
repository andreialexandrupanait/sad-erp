                        ...
                        <div class="mt-6">
                            @if($enabled)
                                <div class="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                    ...
                                    <div>
                                        <p class="font-medium text-green-800 dark:text-green-200">{{ __("Two-factor authentication is enabled") }}</p>
                                        <p class="text-sm text-green-600 dark:text-green-400">{{ __("Your account is protected with an authenticator app.") }}</p>
                                    </div>
                                </div>
                            ...
                            @else
                                <div class="flex items-center gap-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                    ...
                                    <div>
                                        <p class="font-medium text-yellow-800 dark:text-yellow-200">{{ __("Two-factor authentication is not enabled") }}</p>
                                        <p class="text-sm text-yellow-600 dark:text-yellow-400">{{ __("Enable 2FA to add an extra layer of security.") }}</p>
                                    </div>
                                </div>
