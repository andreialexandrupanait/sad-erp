                    ...
                    <section>
                        ...
                        <div class="mt-6 flex flex-col items-center">
                            ...
                            <div class="mt-4 text-center">
                                <p class="text-sm text-gray-600">{{ __("Or enter this code manually:") }}</p>
                                <code class="mt-2 inline-block px-4 py-2 bg-gray-100 rounded font-mono text-sm tracking-wider">
                                    {{ $secret }}
                                </code>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('profile.two-factor.confirm') }}" class="mt-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">{{ __("Enter the 6-digit code from your authenticator app") }}</p>
