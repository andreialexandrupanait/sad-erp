                                        ...
                                        <div class="flex items-center gap-4">
                                            @if($hasRate)
                                                ...
                                                <form method="POST" action="{{ route('profile.services.destroy', $userService) }}" onsubmit="return confirm('Remove your rate for this service?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="p-1.5 text-red-600 hover:text-red-800">
                                            ...
                                            @else
                                                <form method="POST" action="{{ route('profile.services.store') }}" class="flex items-center gap-2">
                                                    ...
                                                    <button type="submit" class="px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50">
                                                        {{ __("Add Rate") }}
                                                    </button>
                                                </form>
                                            @endif
