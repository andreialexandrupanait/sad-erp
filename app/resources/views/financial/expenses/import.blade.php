        ...
        <div class="px-6 lg:px-8 py-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-600">Upload a CSV file to import multiple expenses at once</p>
                </div>
                <x-ui.button variant="ghost" onclick="window.location.href='{{ route('financial.cheltuieli.index') }}'">
        ...
        <div class="max-w-3xl mx-auto">
                    ...
                    <div class="space-y-4 text-sm text-slate-600">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2 ml-2">
                                ...
                                <code class="px-2 py-1 bg-slate-100 rounded text-xs">category</code>
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside space-y-1 ml-2">
                                <li>Category names will be matched automatically if they exist in your settings</li>
                                <li>Year and month will be calculated automatically from occurred_at date</li>
                                <li>All expenses will be assigned to your user account</li>
                            </ul>
                        </div>
                    </div>
                </x-ui.card-content>
            ...
            <x-ui.card class="mb-6">
                <x-ui.card-content class="flex items-center justify-between">
                    ...
                    <x-ui.button variant="outline" onclick="window.location.href='{{ route('financial.cheltuieli.import.template') }}'">
                        <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <x-ui.card>
                ...
                <x-ui.card-content>
                    <form method="POST" action="{{ route('financial.cheltuieli.import') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex items-center justify-end gap-x-4 pt-4 border-t border-slate-200">
                            <x-ui.button type="button" variant="ghost" onclick="window.location.href='{{ route('financial.cheltuieli.index') }}'">
                                Cancel
                            </x-ui.button>
