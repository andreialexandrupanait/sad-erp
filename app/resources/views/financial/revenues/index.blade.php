<x-app-layout>
    ...
    <div class="p-4 md:p-6" x-data="revenueBulkSelection()">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-2">
                            <p class="text-lg font-bold">
                                <span class="text-green-600">{{ number_format($filteredTotalRon, 0, ',', ' ') }} Lei</span>
            ...
            <div class="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <div class="mt-2">
                            <p class="text-lg font-bold">
                                <span class="text-green-600">{{ number_format($yearTotalRon, 0, ',', ' ') }} Lei</span>
        ...
        <div class="mb-6 bg-white rounded-lg shadow p-4">
            <form method="GET" id="monthForm">
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <a href="{{ route('financial.revenues.index', ['year' => $year, 'clear_month' => 1]) }}" class="text-xs {{ $month ? 'text-blue-600 hover:text-blue-800 hover:underline' : 'text-green-600 font-semibold' }}">
                            ...
                            <x-ui.table-row data-selectable data-revenue-id="{{ $revenue->id }}">
                                ...
                                <x-ui.table-cell class="text-right whitespace-nowrap">
                                    <x-table-actions
                                        ...
                                        @if($revenue->files_count > 0)
                                            @if($revenue->files_count == 1 && $revenue->files->first())
