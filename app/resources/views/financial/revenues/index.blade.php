<x-app-layout>
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-slate-900">Venituri</h1>
            <a href="{{ route('financial.venituri.create') }}" class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700">
                + Adaugă venit
            </a>
        </div>
                    ...
                    @forelse($revenues as $revenue)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right text-sm space-x-2">
                                <a href="{{ route('financial.venituri.edit', $revenue) }}" class="text-blue-600 hover:text-blue-900">Editează</a>
                                <form method="POST" action="{{ route('financial.venituri.destroy', $revenue) }}" class="inline">
                                    @csrf
                                    @method('DELETE')
